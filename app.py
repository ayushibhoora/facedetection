...
def identify_face(facearray):
    model = joblib.load('static/face_recognition_model.pkl') #joblib allows fn work parlly
...
def train_model():
    ...
    for user in userlist:
        for imgname in os.listdir(f'static/faces/{user}'):
            ...
            faces.append(resized_face.ravel())        #.ravel converts multi dim array in 1 dim
            labels.append(user)
